...
# fw = open('D:\Dropbox\ML\DSL-Task-master\data\DSLCC-v2.0\\train-dev\\train3.txt',  'w' , encoding="utf8")
...
vectorizer = TfidfVectorizer(encoding = "utf8", max_features = 200)
...
scores = cross_val_score(logreg_model, feature_matrix_word_1, language_list, cv=cv)
print(scores)